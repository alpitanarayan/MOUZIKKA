...
class View:
    ...
    def show_song_details(self):
        ...
        #to remove the extention of the song name--->
    ...
    def load_previous_song(self):
        try:
            if hasattr(self,"sel_song_index_tuple") == False:                                          #hashattr checks whether the item preset in given code
            ...
            self.playList.select_clear(0,tk.END)                                                  #select_clear() method unselect the selected song does not remove it
    ...
    def remove_song_from_favourites(self):
        fav_song_index_tuple = self.playList.curselection()                                                      #curselection always return tuple
        try:
            if (len(fav_song_index_tuple) == 0):
    ...
    def load_songs_from_favourites(self):
        try:
            load_result = self.player.load_songs_from_favourites()                      #tuple
            result_str = load_result[0]
            if result_str.find("No songs") != -1:                         #find() method return index of searched element otherwise -1
